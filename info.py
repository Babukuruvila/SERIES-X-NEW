...
BOT_TOKEN = environ.get('BOT_TOKEN', "5702230511:AAFM_2rD6fdg6P9yuyb6xow_7WuLNkkuPMg")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://testrobot:testrobot@cluster0.anttlct.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Rajappan")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# FSUB
auth_channel = environ.get('AUTH_CHANNEL', '-1001814326418')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
# Set to False inside the bracket if you don't want to use Request Channel else set it to Channel ID
REQ_CHANNEL = environ.get("REQ_CHANNEL", "-1001814326418")
