...
async def start(client, message):
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply("<b>‼️ --𝗜𝗠𝗣𝗢𝗥𝗧𝗔𝗡𝗧 𝗡𝗢𝗧𝗘-- ‼️\n\nℹ️ Tʜɪs Fɪʟᴇ Oʀ Vᴇᴅɪᴏ Wɪʟʟ Bᴇ Dᴇʟᴇᴛᴇᴅ Iɴ 10 Mɪɴᴜᴛᴇs.\n\nℹ️ Fᴏʀᴡᴀʀᴅ Tʜɪs Fɪʟᴇ Oʀ Vᴇᴅɪᴏ Tᴏ Yᴏᴜʀ Sᴀᴠᴇᴅ Mᴇssᴀɢᴇs Aɴᴅ Sᴛᴀʀᴛ Dᴏᴡɴʟᴏᴀᴅɪɴɢ Fʀᴏᴍ Tʜᴇʀᴇ.</b>",quote=True)
            await asyncio.sleep(600)
            await msg.delete()
