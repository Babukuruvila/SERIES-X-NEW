class script(object):
    START_TXT = """<b>Hello {},
ഇത് Sᴇʀɪᴇs X വേണ്ടി കഷ്ടപ്പെടുന്ന ഒരു പാവം ബോട്ടാണ്. ഇനി നിങ്ങൾക്ക് സീരീസ് കിട്ടണം എങ്കിൽ ഇവിടെ കുത്തി ഇരിക്കാതെ ഞങ്ങളുടെ ഗ്രൂപ്പിൽ കയറുക കൂടാതെ പുതിയ സീരീസ് റിലീസിന് വേണ്ടി താഴെയുള്ള ചാനൽ സബ്സ്ക്രൈബ് കൂടി ചെയ്യുക</b>"""
...
• /request - <code>Tᴏ sᴇɴᴅ ᴀ Series/Sᴇʀɪᴇs ʀᴇᴏ̨ᴜᴇsᴛ ᴛᴏ ʙᴏᴛ ᴀᴅᴍɪɴs. Oɴʟʏ ᴡᴏʀᴋs ᴏɴ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ. [Tʜɪs Cᴏᴍᴍᴀɴᴅ Cᴀɴ Bᴇ Usᴇᴅ Bʏ Aɴʏᴏɴᴇ]</code>
...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""
    ...
    TOP_ALRT_MSG = """Cʜᴇᴄᴋɪɴɢ Fᴏʀ Series Iɴ Dᴀᴛᴀʙᴀsᴇ..."""
...
ɪꜰ ʏᴏᴜ ᴅᴏ ɴᴏᴛ ꜱᴇᴇ ᴛʜᴇ ʀᴇǫᴜᴇsᴛᴇᴅ ᴍᴏᴠɪᴇ / sᴇʀɪᴇs ꜰɪʟᴇ, ʟᴏᴏᴋ ᴀᴛ ᴛʜᴇ ɴᴇxᴛ ᴘᴀɢᴇ"""
    ...
    SELECT = """
ℹ️ Aғᴛᴇʀ 10 Mɪɴᴜᴛᴇs Tʜɪs Mᴇssᴀɢᴇ Wɪʟʟ Bᴇ Dᴇʟᴇᴛᴇᴅ.
